...
export const PersonalityToggle = () => {
    ...
    return (
        <div className="relative group/tooltip">
            <button
                onClick={toggleMode}
                className="group relative flex items-center gap-3 px-4 py-2 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm transition-all duration-300 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2"
